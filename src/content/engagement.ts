...
export const engagementModels: EngagementModel[] = [
  ...
  },
  {
    ...
    description:
      "Migrations, network overhauls, security hardening initiatives, or new-site buildouts scoped up front with clear deliverables and a fixed price, with no open-ended time-and-materials billing.",
